describe('Tests in Login Page', () => {
  ...
  it.only('should fill the login form', () => {
    ...
    cy.findByPlaceholderText('Insira seu e-mail ou telefone')
      .should('be.visible')
      .type(email)
      .should('have.value', email);
    cy.findByPlaceholderText('Insira sua senha')
      .should('be.visible')
      .type(senha)
  ...
  describe('Redirect to other page', () => {
    it('should redirect to the register page', () => {
      cy.findByRole('link', { name: /Cadastrar/i })
        .should('be.visible')
        .click();
    ...
    it('should redirect to the forgot password page', () => {
      cy.findByRole('link', { name: /Recuperar senha/i })
        .should('be.visible')
        .click();
