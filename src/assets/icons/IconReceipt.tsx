...
const IconReceipt = ({ ...rest }: ICustomIcon) => (
  <CustomIcon {...rest}>
    <svg width="64px" height="64px" viewBox="-2 0 32 32" fill="none">
      <g id="SVGRepo_bgCarrier" strokeWidth="0" />
      <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" />
      <g id="SVGRepo_iconCarrier">
        <title>receipt</title> <desc>Created with Sketch Beta.</desc> <defs> </defs>
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="Icon-Set" transform="translate(-414.000000, -775.000000)" fill="#000000">
            <path
