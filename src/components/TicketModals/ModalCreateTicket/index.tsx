...
export const ModalCreateTicket = ({
  ...
  const { ticketPlacesForSelect, loadingTicketPlacesForSelect } = useTicketPlacesForSelect();
  const { ticketServiceTypesForSelect, loadingTicketServiceTypesForSelect } =
            ...
            {({ errors, touched, values, setFieldValue }) => (
              <Form>
                ...
                >
                  ...
                  {ticketPlacesForSelect.map(({ id, label }) => (
