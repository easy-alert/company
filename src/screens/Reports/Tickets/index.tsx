                ...
                buildingsNames:
                    filter.buildings?.length === 0
                        ...
                        : filter.buildings
                              .map(
                                  (building) =>
                                      buildingsForSelect.find((b) => b.nanoId === building)?.name,
                              )
                              .join(", "),
                placesNames:
                ...
                serviceTypesNames:
                    filter.serviceTypes?.length === 0
                        ...
                        : filter.serviceTypes
                              .map(
                                  (serviceType) =>
                                      serviceTypes.find((st) => st.id === serviceType)?.label,
                              )
                              .join(", "),
                statusNames:
                            ...
                            <Form>
                                <Style.FilterWrapper>
                                    ...
                                    >
                                        ...
                                        <option
                                            value="all"
                                            disabled={filter.buildings.length === 0}
                                        >
                                            Todas
                                        </option>
                                        ...
                                        {buildingsForSelect.map((building) => (
                                            <option
                                                ...
                                                key={building.nanoId}
                                                disabled={filter.buildings.some(
                                                    (b) => b === building.nanoId,
                                                )}
                                            >
                                                {building.name}
                                    ...
                                    >
                                        ...
                                        <option
                                            value="all"
                                            disabled={filter.serviceTypes.length === 0}
                                        >
                                            Todos
                                        </option>
                                ...
                                <Style.FilterWrapperFooter>
                                    <Style.FilterButtonWrapper>
                                        <CSVLink
                                            data={csvData}
                                            headers={csvHeaders}
                                            filename={`Relatório de chamados ${new Date().toLocaleDateString(
                                                "pt-BR",
                                            )}`}
                                            ...
                                            filter.buildings?.map((building) => (
                                                <ListTag
                                                    ...
                                                    onClick={() => {
                                                        setFilter((prevState) => ({
                                                            ...prevState,
                                                            buildings: prevState.buildings?.filter(
                                                                (b) => b !== building,
                                                            ),
                                                        }));
                                                    }}
                                        ...
                                        {filter.places?.length === 0 ? (
                                            ...
                                            filter.places?.map((place) => (
                                                <ListTag
                                                    key={place}
                                                    label={
                                                        ticketPlaces.find((p) => p.id === place)
                                                            ?.label || ""
                                                    }
                                                    padding="4px 12px"
                                                    fontWeight={500}
                    ...
                    <>
                        <Style.CountContainer>
                            <Style.Counts>
                                ...
                                <Style.CountsInfo
                                    color={
                                        ticketStatus.find((ts) => ts.name === "awaitingToFinish")
                                            ?.backgroundColor
                                    }
                                >
                                ...
                                <Style.CountsInfo
                                    color={
                                        ticketStatus.find((ts) => ts.name === "finished")
                                            ?.backgroundColor
                                    }
                                >
                                ...
                                <Style.CountsInfo
                                    color={
                                        ticketStatus.find((ts) => ts.name === "dismissed")
                                            ?.backgroundColor
                                    }
                                >
                                    <h5 className="dismissed">{dismissedCount}</h5>
                                    <p className="p5">
                                        {dismissedCount > 1 ? "Indeferidos" : "Indeferido"}
                                    </p>
                                </Style.CountsInfo>
                            </Style.Counts>
                        </Style.CountContainer>
